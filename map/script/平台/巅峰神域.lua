...
mt.skills = {
    '游戏难度说明','地图等级说明1','地图等级1','地图等级2','挖宝积分说明','勇士徽章说明','神龙碎片说明','宠物天赋说明','比武积分说明','其它可存档内容说明'
}
...
mt.skills = {
    '梦蝶仙翼','天罡苍羽翼','白龙凝酥翼','天使之光','白羽金虹翼','玄羽绣云翼','龙吟双形翼','金鳞双型翼','绝世阳炎翼','轮迴幻魔翼'
}
...
mt.skills = {
    '血雾领域','龙腾领域','飞沙热浪领域','灵霄烟涛领域','白云四海领域','烈火金焰领域','烈火天翔领域','赤霞万象领域','孤风青龙领域','远影苍龙领域'
}
--循环遍历 skill_book 的技能
