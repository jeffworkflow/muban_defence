...
|cffffe799【获得方式】：|r
|cff00ffff抓青蛙活动获得 |cffff0000重复完成可升级成就|r |cff00ffff最大等级=5
...
--目标类型
target_type = ac.skill.TARGET_TYPE_NONE,
['杀怪加全属性'] = {16.8,33.6,46.6,56.6,66.6},
['杀敌数加成'] = {16.8,33.6,46.6,56.6,66.6},
['攻击减甲'] = {16.8,33.6,46.6,56.6,66.6},
['物理伤害加深'] = {16.8,33.6,46.6,56.6,66.6},
need_map_level = 5,
}
...
--目标类型
target_type = ac.skill.TARGET_TYPE_NONE,
['杀怪加全属性'] = {18.8,37.6,46.6,56.6,66.6},
['物品获取率'] = {18.8,37.6,46.6,56.6,66.6},
['攻击减甲'] = {18.8,37.6,46.6,56.6,66.6},
['暴击加深'] = {18.8,37.6,46.6,56.6,66.6},
need_map_level = 5,
}
...
|cffffe799【成就说明】：|r
|cff00ffff通过 中秋活动 获得，|cffff0000重复获得可升级成就|r |cff00ffff最大等级=5
...
|cffffe799【成就说明】：|r
|cff00ffff中秋活动期间，每局第一个食用“肥美的螃蟹”的玩家可获得 |cffff0000重复获得成就可升级成就|r |cff00ffff最大等级=40
