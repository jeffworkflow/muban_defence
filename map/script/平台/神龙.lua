...
--说明
tip = [[
|cff00ffff挑战Boss并获得|cff00ff00可存档的碎片（数量=游戏难度）|r |cff00ffff神龙碎片超过|cffffff00 100 |cff00ffff自动获得，已拥有碎片：|r%skin_cnt%
    ...
    function mt:on_cast_start()
        ...
        ac.wait(3*1000,function()
            ...
            unit:event '单位-死亡'(function(trg,unit,killer)
                ...
                player:Map_AddServerValue(key,ac.g_game_degree) --网易服务器
