...
local strong_attr = {
    ...
    ['法师'] = {
        {0,100,'技能冷却',0,'新手法师'},
        {100,300,'技能冷却',2,'见习法师'},
        {300,1000,'技能冷却',4,'资深法师'},
        {1000,2000,'技能冷却',6,'精英法师'},
        {2000,10000,'技能冷却',8,'宗师法师'},
        {10000,10000000,'技能冷却',10,'魔道传奇'},
    },
    ['召唤师'] = {
        {0,100,'全伤加深',0,'新手召唤师'},
        {100,300,'全伤加深',1,'见习召唤师'},
        {300,1000,'全伤加深',2,'资深召唤师'},
        {1000,2000,'全伤加深',3,'精英召唤师'},
        {2000,10000,'全伤加深',4,'宗师召唤师'},
        {10000,10000000,'全伤加深',5,'孤儿的呼唤'},
    },
    ['辅助'] = {
        {0,100,'攻击减甲',0,'新手辅助'},
        {100,300,'攻击减甲',2,'见习辅助'},
        {300,1000,'攻击减甲',4,'资深辅助'},
        {1000,2000,'攻击减甲',6,'精英辅助'},
        {2000,10000,'攻击减甲',8,'宗师辅助'},
        {10000,10000000,'攻击减甲',10,'至贤圣者'},
    },
}
...
function mt:on_add()
    ...
    --增加团队收益部分
    hero:add('格挡',self['格挡'])
    hero:add('攻击减甲',self['攻击减甲'])
    hero:add('攻击距离',self['攻击距离'])
    hero:add('技能冷却',self['技能冷却'])
    hero:add('全伤加深',self['全伤加深'])
