...
ac.skill_list2 = {
    ...
    '血焰神脂','神威','强化后的神威','刀刃旋风','强化后的刀刃旋风','痛苦尖叫',
    '强化后的痛苦尖叫','死亡脉冲','强化后的死亡脉冲','践踏','强化后的践踏','穿刺',
    '强化后的穿刺','水舞','强化后的水舞','缠绕','强化后的缠绕','疾步风','强化后的疾步风',
    '神圣护甲','强化后的神圣护甲','不灭佛隐','强化后的不灭佛隐','血雾神隐','绝对领域','招架之力',
    '强化后的招架之力','水疗术','强化后的水疗术','生生不息','硬化皮肤','闪避','财富','贪婪者的心愿',
    '龙凤佛杀','凰燃天成','狂龙爆','强化后的狂龙爆','红莲爆','强化后的红莲爆','暴击','渡业妖爆','强化后的渡业妖爆','技暴',
    '蚀魂魔舞','强化后的蚀魂魔舞','赤焰魔舞','望远镜','剑空破','吸血鬼','分裂伤害','嗜血术','碧涛妖变',
    '邪灵变','暗之领域','强化后的暗之领域','迷之领域','强化后的迷之领域',
