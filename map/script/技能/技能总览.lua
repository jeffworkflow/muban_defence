...
--强化后的技能
ac.skill_list6 = {
    '强化后的X射线','强化后的不灭佛隐','强化后的刀刃旋风','强化后的憎恶','强化后的招架之力','强化后的星落',
    '强化后的暗之领域','强化后的死亡脉冲','强化后的水疗术','强化后的水舞','强化后的渡业妖爆','强化后的狂龙爆',
    '强化后的疾步风','强化后的痛苦尖叫','强化后的神圣护甲','强化后的神威','强化后的穿刺','强化后的红莲爆',
    '强化后的缠绕','强化后的蚀魂魔舞','强化后的践踏','强化后的迷之领域',
}
--不受技能冷却影响
local temp = {}
