...
|cff00ff00杀敌数加成+45% 物品获取率+45% 木头加成+45% 火灵加成+45%
]],
['杀敌数加成'] = 45,
['物品获取率'] = 45,
['木头加成'] = 45,
...
|cff00ff00点击将砒霜洒向周围1000码的敌人，可减少15%的最大生命
]],
--物品技能
is_skill = true,
--技能目标
...
|cff00ff00攻击1% 几率对敌人造成最大生命值8%的伤害
]],
--唯一
-- unique = true,
--物品技能
