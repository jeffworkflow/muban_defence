...
function mt:add_content()
    ...
    if flag and tran_player then 
        ac.player.self:sendMsg('玩家 |cff00ffff'..player:get_name()..'|r |cff00ffff'..self.name..'|r, |cffff0000'..rand_name..'|r',10)
    end    
    ...
    elseif rand_name == '红色小水滴' then
        ...
        if not skl  then 
            ...
            --给全部玩家发送消息
            ac.player.self:sendMsg("【系统提示】玩家 |cffff0000"..player:get_name()..'|r |cff00ffff时来运转|r,获得成就|cffff0000"'..rand_name..'" |r，奖励 |cffff0000吸血+10%，攻击回血+50W|r',10)
        else
    ...
    elseif rand_name == '发光的蓝色灰烬' then
        ...
        if not skl  then 
            ...
            player.is_show_nickname = rand_name
            --给全部玩家发送消息
            ac.player.self:sendMsg("【系统提示】玩家 |cffff0000"..player:get_name()..'|r |cff00ffff时来运转|r,获得成就|cffff0000"'..rand_name..'" |r，奖励 |cffff0000暴击几率+2.5%，暴击伤害+25%|r',10)
        else
            player:sendMsg('玩家 |cff00ffff'..player:get_name()..'|r |cff00ffff'..self.name..'|r, |cffff0000已拥有 '..rand_name..' 什么事都没发生|r',10)
        end  
    elseif rand_name == '发光的草药' then
        ...
        if not skl  then 
            ...
            player.is_show_nickname = rand_name
            --给全部玩家发送消息
            ac.player.self:sendMsg("【系统提示】玩家 |cffff0000"..player:get_name()..'|r |cff00ffff时来运转|r,获得成就|cffff0000"'..rand_name..'" |r，奖励 |cffff0000免伤几率+5%，每秒回血+5%|r',10)
        else
            player:sendMsg('玩家 |cff00ffff'..player:get_name()..'|r |cff00ffff'..self.name..'|r, |cffff0000已拥有 '..rand_name..' 什么事都没发生|r',10)
        end  
    elseif rand_name == '奇美拉的头颅' then
        ...
        if not skl  then 
            ...
            player.is_show_nickname = rand_name
            --给全部玩家发送消息
            ac.player.self:sendMsg("【系统提示】玩家 |cffff0000"..player:get_name()..'|r |cff00ffff时来运转|r,获得成就|cffff0000"'..rand_name..'" |r，奖励 |cffff0000分裂伤害+50%，攻击速度+50%|r',10)
        else
            player:sendMsg('玩家 |cff00ffff'..player:get_name()..'|r |cff00ffff'..self.name..'|r, |cffff0000已拥有 '..rand_name..' 什么事都没发生|r',10)
        end
    elseif rand_name == '倒霉蛋' then
        ...
        if not skl  then 
            ...
            player.is_show_nickname = rand_name
            --给全部玩家发送消息
            ac.player.self:sendMsg("【系统提示】玩家 |cffff0000"..player:get_name()..'|r |cff00ffff时来运转|r,获得成就|cffff0000"'..rand_name..'" |r，奖励 |cffff0000木头+5555，火种+5555，杀敌数+5555|r',10)
        else
            player:sendMsg('玩家 |cff00ffff'..player:get_name()..'|r |cff00ffff'..self.name..'|r, |cffff0000已拥有 '..rand_name..' 什么事都没发生|r',10)
        end
