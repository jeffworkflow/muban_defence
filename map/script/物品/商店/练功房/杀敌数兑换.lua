...
ac.exchange_kill ={
    ...
    -- 
    ['杀敌数加成'] = {'杀敌数加成',5,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+5%杀敌数加成|r|n'} ,
    ['木头加成'] = {'木头加成',5,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+5%木头加成|r|n'} ,
    ['物品获取率加成'] = {'物品获取率',25,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+5%物品获取率|r|n'} ,
    ['火灵加成'] = {'火灵加成',5,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+5%火灵加成|r|n'} ,
    ['分裂伤害加成'] = {'分裂伤害',10,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+10%分裂伤害|r|n'} ,
    ['攻速加成'] = {'攻击速度',10,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+10%攻击速度|r|n'} ,
