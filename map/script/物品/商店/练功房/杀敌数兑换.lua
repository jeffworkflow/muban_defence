...
ac.exchange_kill ={
    ...
    ['火种加成'] = {'火种加成',25,4,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+25%火种加成|r|n|n|cffcccccc兑换上限次数：4次|r'} ,
    ...
    ['杀怪全属性成长'] = {'杀怪加全属性',15,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+15杀怪加全属性|r|n'} ,
    ['杀怪攻击成长'] = {'杀怪加攻击',60,999999,1000,[[sdsdh.blp]],'|n|n消耗 |cffff00001000杀敌数|r 兑换一次 |cff00ff00+60杀怪加攻击|r|n'} ,
