        ...
        if hero  then 
            ...
            if p.sjjh_cnt == self.kill_cnt then
                ...
                unit:event '单位-死亡' (function(_,unit,killer) 
                    ...
                    player:sendMsg('|cffFFE799【系统消息】|r恭喜获得 |cff00ff00攻击全属性+1|r 的|cffff0000永久存档奖励|r |cffffe799当前攻击全属性+|cffffe799'..((player.cus_server and player.cus_server['杀鸡儆猴']) or 0)..'|r',6)
                end)    
