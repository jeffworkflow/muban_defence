...
ac.item.suit = {
    ...
    {'【全能神】','全能神的赠礼','全属性','3 全伤加深+12.5% ','5 全伤加深+12.5%'},
    {'【雅典娜】','雅典娜的赠礼','智力','3 技暴几率+7.5% 技暴加深+75% ','5 技暴几率+7.5% 技暴加深+75%' },
    {'【安泰】','安泰的赠礼','力量','3 暴击几率+10% 暴击加深+100% ','5 暴击几率+10% 暴击加深+100%' },
    {'【闪电侠】','闪电侠的赠礼','敏捷','3 攻击间隔-0.125 ','5 攻击间隔-0.125' },
    {'【不死鸟】','不死鸟的赠礼','护甲','3 免伤+10%','5 免伤+10%' },
    {'【海贼王】','海贼王的赠礼','收益','3 物品获取率+35% 木头加成+35% 杀敌数加成+35% 火灵加成+35% ','5 物品获取率+35% 木头加成+35% 杀敌数加成+35% 火灵加成+35% ' },
}
