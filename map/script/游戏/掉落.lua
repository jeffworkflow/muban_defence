...
local unit_reward = {
    ...
    ['初级扭蛋'] = {
        {    rand = 62.761, name = '空蛋' },
        {    rand = 2, name = '力量+35000' },
        {    rand = 2, name = '敏捷+35000',},
        {    rand = 2, name = '智力+35000',},
        {    rand = 2, name = '杀怪加力量+2',},
        {    rand = 2, name = '杀怪加敏捷+2',},
        {    rand = 2, name = '杀怪加智力+2',},
        {    rand = 2, name = '攻击加力量+6',},
        ...
        {    rand = 0.05, name = '神兵',},--lv1-lv5
        {    rand = 0.05, name = '神甲',},--lv1-lv5
        {    rand = 0.1, name = '技能升级书Lv1',}, --lv1
        {    rand = 0.1, name = '技能升级书Lv2',}, --lv2
    ...
    ['高级扭蛋'] = {
        ...
        {    rand = 2, name = '护甲+500',},
        {    rand = 2, name = '每秒加护甲+0.5',},
        {    rand = 0.07, name = '护甲+5000',},
        {    rand = 0.07, name = '每秒加护甲+5',},
        {    rand = 0.007, name = '护甲+50000',},
        {    rand = 0.007, name = '每秒加护甲+50',},

        {    rand = 1, name = '宠物经验书(大)',},
        {    rand = 0.05, name = '吞噬丹',},
        {    rand = 0.25, name = '随机技能',},
        {    rand = 2, name = '随机物品',}, --和商店一样 '凝脂剑','元烟剑','暗影','青涛魔剑','青虹紫霄剑'
        {    rand = 0.05, name = '神兵',},--lv6-lv10
        {    rand = 0.05, name = '神甲',},--lv6-lv10
        {    rand = 0.1, name = '技能升级书Lv3',}, --lv1
        {    rand = 0.1, name = '技能升级书Lv4',}, --lv2
