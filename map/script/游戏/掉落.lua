...
local unit_reward = {
    ...
    ['藏宝图'] =  {
        ...
        {    rand = 10, name = '随机物品',},
        {    rand = 15, name = '随机技能',},
        {    rand = 1, name = '杀怪加力量+50 攻击加力量+150 每秒加力量+250' },
        {    rand = 1, name = '杀怪加敏捷+50 攻击加敏捷+150 每秒加敏捷+250',},
        {    rand = 1, name = '杀怪加智力+50 攻击加智力+150 每秒加智力+250',},
        {    rand = 1, name = '杀怪加攻击+100 每秒加攻击+500',},
        {    rand = 1, name = '每秒加护甲1',},
        {    rand = 1, name = '宠物经验书（小）',},
        {    rand = 1, name = '宠物经验书（大）',},
        {    rand = 2, name = '火灵+10000',},
        {    rand = 2, name = '木头+5000',},
