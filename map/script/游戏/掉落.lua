...
local unit_reward = {
    ...
    ['初级扭蛋'] = {
        ...
        -- {    rand = 0.01, name = '吞噬丹',},
        {    rand = 0.01, name = '随机技能',},
        {    rand = 0.3, name = '随机物品',}, --和商店一样 '凝脂剑','元烟剑','暗影','青涛魔剑','青虹紫霄剑'
    ...
    ['高级扭蛋'] = {
        ...
        {    rand = 4, name = '力量+400000' },
        {    rand = 4, name = '敏捷+400000',},
        {    rand = 4, name = '智力+400000',},
        {    rand = 4, name = '杀怪加力量+25',},
        {    rand = 4, name = '杀怪加敏捷+25',},
        {    rand = 4, name = '杀怪加智力+25',},
        {    rand = 4, name = '攻击加力量+75',},
        {    rand = 4, name = '攻击加敏捷+75',},
        {    rand = 4, name = '攻击加智力+75',},
        {    rand = 4, name = '每秒加力量+125',},
        {    rand = 4, name = '每秒加敏捷+125',},
        {    rand = 4, name = '每秒加智力+125',},
