...
local unit_reward = {
    ...
    ['初级扭蛋'] = {
        ...
        {    rand = 0.07, name = '力量+35000' },
        {    rand = 0.07, name = '敏捷+35000',},
        {    rand = 0.07, name = '智力+35000',},
        ...
        {    rand = 0.007, name = '力量+350000' },
        {    rand = 0.007, name = '敏捷+350000',},
        {    rand = 0.007, name = '智力+350000',},
        ...
        {    rand = 0.07, name = '护甲+100',},
        {    rand = 0.07, name = '每秒加护甲+0.5',},
        {    rand = 0.007, name = '护甲+1000',},
        ...
        {    rand = 0.03, name = '神兵',},--lv1-lv5
        {    rand = 0.03, name = '神甲',},--lv1-lv5
        {    rand = 0.05, name = '技能升级书Lv1',}, --lv1
        {    rand = 0.05, name = '技能升级书Lv2',}, --lv2
        {    rand = 0.02, name = '一号洗练石',},
        {    rand = 0.02, name = '二号洗练石',},

        {    rand = 0.1, name = '红色小水滴',},--红色小水滴 吸血+10% 攻击回血+500000
        {    rand = 0.1, name = '黄金罗盘',},--暴击几率+2.5%，暴击加深+35%
    ...
    ['高级扭蛋'] = {
        ...
        {    rand = 0.07, name = '力量+8000000' },
        {    rand = 0.07, name = '敏捷+8000000',},
        {    rand = 0.07, name = '智力+8000000',},
        ...
        {    rand = 0.007, name = '力量+50000000' },
        {    rand = 0.007, name = '敏捷+50000000',},
        {    rand = 0.007, name = '智力+50000000',},
        ...
        {    rand = 0.07, name = '每秒加攻击+5000',},
        {    rand = 0.007, name = '攻击+200000000',},
        {    rand = 0.007, name = '杀怪加攻击+10000',},
        {    rand = 0.007, name = '每秒加攻击+50000',},

        {    rand = 2, name = '护甲+250',},
        {    rand = 2, name = '每秒加护甲+1.25',},
        {    rand = 0.07, name = '护甲+2500',},
        {    rand = 0.07, name = '每秒加护甲+12.5',},
        {    rand = 0.007, name = '护甲+25000',},
        {    rand = 0.007, name = '每秒加护甲+125',},

        {    rand = 1, name = '宠物经验书(大)',},
        {    rand = 0.05, name = '吞噬丹',},
        {    rand = 0.25, name = '随机技能',},
        {    rand = 2, name = '随机物品',}, --和商店一样 '凝脂剑','元烟剑','暗影','青涛魔剑','青虹紫霄剑'
        {    rand = 0.03, name = '神兵',},--lv6-lv10
        {    rand = 0.03, name = '神甲',},--lv6-lv10
        {    rand = 0.05, name = '技能升级书Lv3',}, --lv1
        {    rand = 0.05, name = '技能升级书Lv4',}, --lv2
        {    rand = 0.02, name = '三号洗练石',},
        {    rand = 0.02, name = '四号洗练石',},

        {    rand = 0.03, name = '格里芬',}, --lv1
        {    rand = 0.03, name = '黑暗项链',}, --lv2
        {    rand = 0.03, name = '最强生物心脏',}, --lv1
        {    rand = 0.03, name = '白胡子的大刀',}, --lv2
