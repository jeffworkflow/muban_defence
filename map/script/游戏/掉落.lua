...
local unit_reward = {
    ...
    ['藏宝图'] =  {
        ...
        {    rand = 10, name = '随机物品',},
        {    rand = 10, name = '随机技能',},
        {    rand = 0.75, name = '杀怪加力量+5 攻击加力量+15 每秒加力量+25' },
        {    rand = 0.75, name = '杀怪加敏捷+5 攻击加敏捷+15 每秒加敏捷+25',},
        {    rand = 0.75, name = '杀怪加智力+5 攻击加智力+15 每秒加智力+25',},
        {    rand = 0.75, name = '杀怪加攻击+5 每秒加攻击+50',},
        {    rand = 0.75, name = '每秒加护甲0.25',},
        {    rand = 0.5, name = '宠物经验书（小）',},
        {    rand = 0.5, name = '宠物经验书（大）',},
        {    rand = 0.25, name = '挖宝达人',}, --500万全属性，物品获取率+50%	
    },
    ['抽奖券'] =  {
        {    rand = 70,  name ={
                { rand = 0.5, name = '欧皇达人'},
    ...
    ['初级扭蛋'] = {
        {    rand = 61.01, name = '空蛋' },
        {    rand = 2.43, name = '力量+3500' },
        {    rand = 2.5, name = '敏捷+3500',},
        {    rand = 2.5, name = '智力+3500',},
        {    rand = 2, name = '杀怪加力量+2',},
        {    rand = 2, name = '杀怪加敏捷+2',},
        {    rand = 2, name = '杀怪加智力+2',},
        {    rand = 2, name = '攻击加力量+6',},
        {    rand = 2, name = '攻击加敏捷+6',},
        {    rand = 2, name = '攻击加智力+6',},
        {    rand = 2, name = '每秒加力量+10',},
        {    rand = 2, name = '每秒加敏捷+10',},
        {    rand = 2, name = '每秒加智力+10',},

        {    rand = 0.1, name = '力量+35000' },
        {    rand = 0.1, name = '敏捷+35000',},
        {    rand = 0.1, name = '智力+35000',},
        {    rand = 0.1, name = '杀怪加力量+20',},
        {    rand = 0.1, name = '杀怪加敏捷+20',},
        {    rand = 0.1, name = '杀怪加智力+20',},
        {    rand = 0.1, name = '攻击加力量+60',},
        {    rand = 0.1, name = '攻击加敏捷+60',},
        {    rand = 0.1, name = '攻击加智力+60',},
        {    rand = 0.1, name = '每秒加力量+100',},
        {    rand = 0.1, name = '每秒加敏捷+100',},
        {    rand = 0.1, name = '每秒加智力+100',},

        {    rand = 0.01, name = '力量+350000' },
        {    rand = 0.01, name = '敏捷+350000',},
        {    rand = 0.01, name = '智力+350000',},
        {    rand = 0.01, name = '杀怪加力量+200',},
        {    rand = 0.01, name = '杀怪加敏捷+200',},
        {    rand = 0.01, name = '杀怪加智力+200',},
        {    rand = 0.01, name = '攻击加力量+600',},
        {    rand = 0.01, name = '攻击加敏捷+600',},
        {    rand = 0.01, name = '攻击加智力+600',},
        {    rand = 0.01, name = '每秒加力量+1000',},
        {    rand = 0.01, name = '每秒加敏捷+1000',},
        {    rand = 0.01, name = '每秒加智力+1000',},

        {    rand = 2, name = '攻击+200000',},
        {    rand = 2, name = '杀怪加攻击+4',},
        {    rand = 2, name = '每秒加攻击+20',},
        {    rand = 0.1, name = '攻击+2000000',},
        {    rand = 0.1, name = '杀怪加攻击+40',},
        {    rand = 0.1, name = '每秒加攻击+200',},
        {    rand = 0.01, name = '攻击+20000000',},
        {    rand = 0.01, name = '杀怪加攻击+400',},
        {    rand = 0.01, name = '每秒加攻击+2000',},

        {    rand = 2, name = '护甲+10',},
        {    rand = 2, name = '每秒加护甲+0.05',},
        {    rand = 0.1, name = '护甲+100',},
        {    rand = 0.1, name = '每秒加护甲+0.5',},
        {    rand = 0.01, name = '护甲+1000',},
        {    rand = 0.01, name = '每秒加护甲+5',},
        ...
        {    rand = 0.1, name = '发光的蓝色灰烬',},--暴击几率+2.5%，暴击加深+35%
        {    rand = 0.1, name = '发光的草药',},--免伤几率+5%，每秒回血+5%
        {    rand = 0.1, name = '奇美拉的头颅',},--分裂伤害+50%，攻击速度+50%

        {    rand = 0.01, name = '倒霉蛋',},--木头+5555，火灵+5555，杀敌数+5555
    },
    ['高级扭蛋'] = {
        {    rand = 60.12, name = '空蛋' },
        {    rand = 2, name = '力量+870000' },
        {    rand = 2, name = '敏捷+870000',},
        {    rand = 2, name = '智力+870000',},
        {    rand = 2, name = '杀怪加力量+50',},
        {    rand = 2, name = '杀怪加敏捷+50',},
        {    rand = 2, name = '杀怪加智力+50',},
        {    rand = 2, name = '攻击加力量+150',},
        {    rand = 2, name = '攻击加敏捷+150',},
        {    rand = 2, name = '攻击加智力+150',},
        {    rand = 2, name = '每秒加力量+250',},
        {    rand = 2, name = '每秒加敏捷+250',},
        {    rand = 2, name = '每秒加智力+250',},

        {    rand = 0.1, name = '力量+8700000' },
        {    rand = 0.1, name = '敏捷+8700000',},
        {    rand = 0.1, name = '智力+8700000',},
        {    rand = 0.1, name = '杀怪加力量+500',},
        {    rand = 0.1, name = '杀怪加敏捷+500',},
        {    rand = 0.1, name = '杀怪加智力+500',},
        {    rand = 0.1, name = '攻击加力量+1500',},
        {    rand = 0.1, name = '攻击加敏捷+1500',},
        {    rand = 0.1, name = '攻击加智力+1500',},
        {    rand = 0.1, name = '每秒加力量+2500',},
        {    rand = 0.1, name = '每秒加敏捷+2500',},
        {    rand = 0.1, name = '每秒加智力+2500',},

        {    rand = 0.01, name = '力量+87000000' },
        {    rand = 0.01, name = '敏捷+87000000',},
        {    rand = 0.01, name = '智力+87000000',},
        {    rand = 0.01, name = '杀怪加力量+5000',},
        {    rand = 0.01, name = '杀怪加敏捷+5000',},
        {    rand = 0.01, name = '杀怪加智力+5000',},
        {    rand = 0.01, name = '攻击加力量+15000',},
        {    rand = 0.01, name = '攻击加敏捷+15000',},
        {    rand = 0.01, name = '攻击加智力+15000',},
        {    rand = 0.01, name = '每秒加力量+25000',},
        {    rand = 0.01, name = '每秒加敏捷+25000',},
        {    rand = 0.01, name = '每秒加智力+25000',},

        {    rand = 2, name = '攻击+2500000',},
        {    rand = 2, name = '杀怪加攻击+100',},
        {    rand = 2, name = '每秒加攻击+500',},
        {    rand = 0.1, name = '攻击+25000000',},
        {    rand = 0.1, name = '杀怪加攻击+1000',},
        {    rand = 0.1, name = '每秒加攻击+5000',},
        {    rand = 0.01, name = '攻击+250000000',},
        {    rand = 0.01, name = '杀怪加攻击+10000',},
        {    rand = 0.01, name = '每秒加攻击+50000',},

        {    rand = 2, name = '护甲+250',},
        {    rand = 2, name = '每秒加护甲+1.25',},
        {    rand = 0.1, name = '护甲+2500',},
        {    rand = 0.1, name = '每秒加护甲+12.5',},
        {    rand = 0.01, name = '护甲+25000',},
        {    rand = 0.01, name = '每秒加护甲+125',},
    ...
    ['星星之火守卫'] = {{rand =7.5,name = '星星之火碎片'}},
    ['陨落心炎守卫'] = {{rand =7.5,name = '陨落心炎碎片'}},
    ['三千焱炎火守卫'] = {{rand =7.5,name = '三千焱炎火碎片'}},
    ['虚无吞炎守卫'] = {{rand =7.5,name = '虚无吞炎碎片'}},

    ['星星之火boss'] = {
        {rand =50,name = '星星之火碎片*1'},
        {rand =50,name = '星星之火碎片*10'},
    },
    ['陨落心炎boss'] = {
        {rand =50,name = '陨落心炎碎片*1'},
        {rand =50,name = '陨落心炎碎片*10'}
    },
    ['三千焱炎火boss'] = {
        {rand =50,name = '三千焱炎火碎片*1'},
        {rand =50,name = '三千焱炎火碎片*10'},
    },
    ['虚无吞炎boss'] = {
        {rand =50,name = '虚无吞炎碎片*1'},
        {rand =50,name = '虚无吞炎碎片*10'},
    },
