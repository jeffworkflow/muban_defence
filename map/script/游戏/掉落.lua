...
local unit_reward = {
    ...
    ['藏宝图'] =  {
        ...
        {    rand = 10, name = '随机物品',},
        {    rand = 15, name = '随机技能',},
        {    rand = 1.5, name = '杀怪加力量+100 攻击加力量+300 每秒加力量+500' },
        {    rand = 1.5, name = '杀怪加敏捷+100 攻击加敏捷+300 每秒加敏捷+500',},
        {    rand = 1.5, name = '杀怪加智力+100 攻击加智力+300 每秒加智力+500',},
        {    rand = 1.5, name = '杀怪加攻击+200 每秒加攻击+1000',},
        {    rand = 1.5, name = '每秒加护甲+2',},
        {    rand = 1, name = '宠物经验书（小）',},
        {    rand = 1, name = '宠物经验书（大）',},
        {    rand = 2, name = '火灵',},
        {    rand = 2, name = '木头',},
    ...
    ['高级扭蛋'] = {
        ...
        {    rand = 4, name = '杀怪加力量+15',},
        {    rand = 4, name = '杀怪加敏捷+15',},
        {    rand = 4, name = '杀怪加智力+15',},
        {    rand = 4, name = '攻击加力量+45',},
        {    rand = 4, name = '攻击加敏捷+45',},
        {    rand = 4, name = '攻击加智力+45',},
        {    rand = 4, name = '每秒加力量+75',},
        {    rand = 4, name = '每秒加敏捷+75',},
        {    rand = 4, name = '每秒加智力+75',},

        {    rand = 0.07, name = '力量+5000000' },
        {    rand = 0.07, name = '敏捷+5000000',},
        {    rand = 0.07, name = '智力+5000000',},
        {    rand = 0.07, name = '杀怪加力量+300',},
        {    rand = 0.07, name = '杀怪加敏捷+300',},
        {    rand = 0.07, name = '杀怪加智力+300',},
        {    rand = 0.07, name = '攻击加力量+900',},
        {    rand = 0.07, name = '攻击加敏捷+900',},
        {    rand = 0.07, name = '攻击加智力+900',},
        {    rand = 0.07, name = '每秒加力量+1500',},
        {    rand = 0.07, name = '每秒加敏捷+1500',},
        {    rand = 0.07, name = '每秒加智力+1500',},

        {    rand = 0.007, name = '力量+30000000' },
        {    rand = 0.007, name = '敏捷+30000000',},
        {    rand = 0.007, name = '智力+30000000',},
        {    rand = 0.007, name = '杀怪加力量+3000',},
        {    rand = 0.007, name = '杀怪加敏捷+3000',},
        {    rand = 0.007, name = '杀怪加智力+3000',},
        {    rand = 0.007, name = '攻击加力量+9000',},
        {    rand = 0.007, name = '攻击加敏捷+9000',},
        {    rand = 0.007, name = '攻击加智力+9000',},
        {    rand = 0.007, name = '每秒加力量+15000',},
        {    rand = 0.007, name = '每秒加敏捷+15000',},
        {    rand = 0.007, name = '每秒加智力+15000',},
        ...
        {    rand = 2, name = '护甲+300',},
        {    rand = 2, name = '每秒加护甲+0.3',},
        {    rand = 0.07, name = '护甲+3000',},
        {    rand = 0.07, name = '每秒加护甲+3',},
        {    rand = 0.007, name = '护甲+30000',},
        {    rand = 0.007, name = '每秒加护甲+30',},

        {    rand = 0.6, name = '宠物经验书(大)',},
        {    rand = 0.03, name = '吞噬丹',},
        {    rand = 0.2, name = '随机技能',},
        {    rand = 4, name = '随机物品',}, --和商店一样 '凝脂剑','元烟剑','暗影','青涛魔剑','青虹紫霄剑'
    ...
    ['星星之火守卫'] = {{rand =10,name = '星星之火碎片'}},
    ['陨落心炎守卫'] = {{rand =10,name = '陨落心炎碎片'}},
    ['三千焱炎火守卫'] = {{rand =10,name = '三千焱炎火碎片'}},
    ['虚无吞炎守卫'] = {{rand =10,name = '虚无吞炎碎片'}},
